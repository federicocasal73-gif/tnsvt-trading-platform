...
func LoadServices(path string) []ServiceConfig {
	defaultCfg := []ServiceConfig{
		...
		},
		{
			...
			Instances:  []string{"http://audit-engine:8008"},
			Timeout:    5000,
			RateLimit:  200,
			HealthPath: "/health",
			Required:   true,
		},
		{
			...
			Instances:  []string{"http://ai-core:8010"},
			Timeout:    30000,
			RateLimit:  50,
			HealthPath: "/health",
			Required:   false,
		},
		{
			...
			Instances:  []string{"http://regime-detector:8011"},
			Timeout:    10000,
			RateLimit:  100,
			HealthPath: "/health",
			Required:   false,
		},
		{
			...
			Instances:  []string{"http://price-feed:8012"},
			Timeout:    5000,
			RateLimit:  300,
			HealthPath: "/health",
			Required:   false,
		},
		{
			...
			Instances:  []string{"http://telegram-notifier:8013"},
			Timeout:    10000,
			RateLimit:  100,
			HealthPath: "/health",
			Required:   false,
